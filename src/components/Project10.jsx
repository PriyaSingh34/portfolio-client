...
import proj10img1 from "../assets/proj10img1.jpeg";
import proj10img2 from "../assets/proj10img2.jpeg";
    ...
    <div id="projecthead" className="flex flex-col gap-4 bg-black w-full h-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-5 lg:gap-28">
          <p className="heading-font text-[17px] w-full lg:w-[40%] text-[#FFFFFBF] leading-8">
            People long to feel that they matter. We know a simple, heartfelt
            message can turn a frown into a smile, despair into hope and a bad
            day into a great one. A Higher Thought was created to enable others
            to share short inspirational positive videos to uplift the global
            conversation online. We know a simple, heartfelt message can turn a
            frown into a smile, despair into hope and a bad day into a great
            one. A Higher Thought provides you with engaging tools and content
            to help you make a difference in the lives of others through a
            message of appreciation, love and hope.
          </p>
        </div>

        <div className="flex flex-col gap-4">
          <img src={proj10img1} alt="" />
          <img src={proj10img2} alt="" />
        </div>
